...
namespace OpenXML.Models
{
    class FTP
    {
        ...
        public static string DownloadFile(string sourceFileUrl, string destinationFilePath, string username = Constants.Location.FTP.Username, string password = Constants.Location.FTP.Password)
        {
            string output;
